...
if ( ! class_exists( 'VW_Project_Management_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class VW_Project_Management_WPTT_WebFont_Loader {
...
if ( ! function_exists( ' vw_project_management_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function  vw_project_management_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new VW_Project_Management_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( ' vw_project_management_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function  vw_project_management_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new VW_Project_Management_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
