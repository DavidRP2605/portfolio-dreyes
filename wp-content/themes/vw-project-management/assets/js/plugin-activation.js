jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_project_management_plugin_activate_plugin;

    $(document).on('click', '.vw-project-management-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-project-management-plugin-install');
                button.addClass('button-primary vw-project-management-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-project-management-recommended-plugins .vw-project-management-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-project-management-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-project-management-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-project-management-recommended-plugins').css('display','none');
    });
